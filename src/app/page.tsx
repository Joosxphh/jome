  ...
  return (
    <div className="min-h-screen bg-gray-100 font-sans">
      <section id="home" className="relative h-screen">
        ...
        >
          <h2 className="text-5xl font-serif font-bold mb-4 text-secondaire">
            Bienvenue chez Jome
          </h2>
          <p className="text-lg mb-8">
            Les meilleurs pizza de la ville, avec des ingrédients frais
          </p>
        </div>
      </section>
      <div className="bg-principale">
        <section id="carousel " className="py-16 bg-white">
          <h2 className="text-secondaire text-5xl font-serif font-bold mb-4 text-center">
            Nos pizza
          </h2>
          <Carousel
            opts={{
        ...
        <div className="flex space-x-4 justify-center py-8">
          ...
          <IconBanner
            imageSrc="/Ingredients.png"
            title="Ingrédients de saison"
          />
          <IconBanner
            imageSrc="/enseigne-engagee.png"
            title="Enseigne engagée"
          />
        ...
        <div className="bg-white">
          <main className=" container mx-auto p-4 ">
            <h2 className="text-secondaire text-4xl font-serif font-bold mb-4 ">
              Nos Menu
            </h2>
            ...
            <h2 className="text-secondaire text-4xl font-serif font-bold mb-4 pt-12">
              Nos Recettes
            </h2>
            <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <MenuCard
